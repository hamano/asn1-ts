...
class CERElement extends x690_1.default {
    ...
    static fromSequence(sequence) {
        const ret = new CERElement(values_1.ASN1TagClass.universal, values_1.ASN1Construction.constructed, values_1.ASN1UniversalType.sequence);
    ...
    toBytes() {
        ...
        switch (this.construction) {
            case (values_1.ASN1Construction.primitive): {
            ...
            case (values_1.ASN1Construction.constructed): {
        ...
        const ret = new Uint8Array(tagBytes.length
            + lengthOctets.length
            + this.value.length
            + (this.construction === values_1.ASN1Construction.constructed ? 2 : 0));
        ret.set(tagBytes, 0);
